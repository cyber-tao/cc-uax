...
fn parse_coverage_add_assign_doubles_every_serialized_field() {
    ...
    let base = ParseCoverage {
        ...
        pins_decoded: 12,
        graph_edges_decoded: 13,
        rigvm_graphs_total: 14,
        rigvm_graphs_decoded: 15,
        rigvm_nodes_total: 16,
        rigvm_nodes_decoded: 17,
        rigvm_pins_total: 18,
        rigvm_pins_decoded: 19,
        rigvm_links_total: 20,
        rigvm_links_decoded: 21,
        pcg_graphs_total: 22,
        pcg_graphs_decoded: 23,
        pcg_nodes_total: 24,
        pcg_nodes_decoded: 25,
        pcg_pins_total: 26,
        pcg_pins_decoded: 27,
        pcg_edges_total: 28,
        pcg_edges_decoded: 29,
        state_tree_graphs_total: 30,
        state_tree_graphs_decoded: 31,
        state_tree_states_total: 32,
        state_tree_states_decoded: 33,
        state_tree_tasks_decoded: 34,
        state_tree_conditions_decoded: 35,
        state_tree_transitions_decoded: 36,
        script_structs_total: 37,
        script_structs_decoded: 38,
        script_properties_decoded: 39,
        script_bytecode_bytes: 40,
        ...
        diagnostic_errors: 47,
        diagnostic_warnings: 48,
    };
